...
public class UserController {
    ...
    public static List<UserModel> getAllUsers() {
        ...
        /* return List.of(
            ...
            new UserModel("0004", "Pakaya", "paka123", "Pakmantha", "0718274567", "Admin")
        ); */
    }
     
    //Method to create a user
    public static boolean createUser(UserModel user, String groupId) {
        try {
            return RemoteHandler.getRemoteUser().createUser(user, groupId);
